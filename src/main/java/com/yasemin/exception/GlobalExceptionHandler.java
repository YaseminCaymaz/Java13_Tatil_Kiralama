...
import static com.yasemin.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TatilKiralamaException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> tatilKiralamaExceptionHandler(TatilKiralamaException tatilKiralamaException){
        return new ResponseEntity<>(createErrorMessage(tatilKiralamaException,tatilKiralamaException.getErrorType()),
                tatilKiralamaException.getErrorType().getHttpStatus());
    }
